...
main1:  mov ax,3        ;ф-я установки текстового видеорежима
        ...
        mov dh,0        ;x 1-го сообщения
        mov dl,0        ;y 1-го сообщения
        mov ah,9        ;цвет
        call printtext  ;вывести сообщение
        mov si,msg2     ;сообщение
        mov dh,3        ;x 2-го сообщения
        mov dl,1        ;y 2-го сообщения
        mov ah,14       ;цвет
        call printtext  ;вывести сообщение

        mov al,0dbh     ;код символа
        mov ah,10       ;цвет
        mov dh,60       ;начальный х фигуры
        mov dl,18       ;начальный y фигуры
...
lp1:    call printchar  ;вывести символ
        ...
        cmp dl,20       ;пока не достигли заданной строки
        jnz lp2         ;продолжить
...
lp4:    call printchar  ;вывести символ
        ...
        inc dl          ;перейти на следующую строку экрана
        cmp dl,23       ;пока не достигли заданной строки
        jnz lp3         ;продолжить
